...
Notation H := (TimestampRefSingle.header + TimestampSpecSingle.header).
Notation A := (Sum.sum TimestampRefSingle.aut TimestampSpecSingle.aut).
Notation conf := (P4automaton.configuration (P4A.interp A)).
Notation start_left := TimestampRefSingle.Start.
...
RegisterEnvCtors
  (TimestampRefSingle.Typ, FirstOrderConfRelSimplified.Bits 8)
  (TimestampRefSingle.Len, FirstOrderConfRelSimplified.Bits 8)
  (TimestampRefSingle.Value, FirstOrderConfRelSimplified.Bits 48)
  (TimestampRefSingle.Scratch8, FirstOrderConfRelSimplified.Bits 8)
  (TimestampRefSingle.Scratch16, FirstOrderConfRelSimplified.Bits 16)
  (TimestampRefSingle.Scratch24, FirstOrderConfRelSimplified.Bits 24)
  (TimestampRefSingle.Scratch32, FirstOrderConfRelSimplified.Bits 32)
  (TimestampRefSingle.Scratch40, FirstOrderConfRelSimplified.Bits 40)
