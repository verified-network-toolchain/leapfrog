...
Notation "extract( hdr )" := (OpExtract (existT _ _ hdr%p4a))%p4a (at level 60) : p4a_scope.

Notation "extract( hdr , n )" := (OpExtract (existT _ n hdr%p4a))%p4a (at level 60) : p4a_scope.

Notation " e [ hi -- lo ]" := (ESlice e%p4a hi lo)%p4a (at level 10) : p4a_scope.
